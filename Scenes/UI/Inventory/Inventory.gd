...
func _ready() -> void:
	var __ = EVENTS.connect("object_collected", self, "_on_object_collected")
...
# and returns its id. If no ItemAmount correspons, it returns -1
...
func _on_object_collected(obj : Object) -> void:
	if obj is Item:
